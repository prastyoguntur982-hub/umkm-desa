  ...
  @section('content')
      <div class=" pl-2 pr-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          <div
              ...
              <button type="button" data-modal-target="tambah-Alur" data-modal-toggle="tambah-Alur"
              ...
              @include('components.admin.modalTambah-Alur')
              ...
              <table class="datatable w-full text-sm text-left text-gray-700 dark:text-gray-200">
                  <thead class="text-xs uppercase bg-gray-100 dark:bg-gray-700">
                      <tr>
                          ...
                          <th class="px-4 py-3">UU Terkait</th>
                  ...
                  <tbody class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                      @foreach ($alur as $item)
                          <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                              ...
                              <td class="px-4 py-2">{{ $item->uu_terkait }}</td>

                              <td class="px-4 py-2">
                                  <button onclick="openFotoModal('{{ asset('storage/' . $item->gambar) }}')"
                              ...
                              <td class="px-4 py-2 space-x-2">
                                  <button type="button" data-modal-target="edit-Alur-{{ $item->id }}"
                                      data-modal-toggle="edit-Alur-{{ $item->id }}"
                                      class="text-yellow-600 hover:underline">
                                      Edit
                                  </button>

                                  @include('components.admin.modalEdit-Alur')



                                  <button onclick="deleteForm('{{ route('admin.alur.destroy', $item->id) }}')"
