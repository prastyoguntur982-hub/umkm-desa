  ...
  @section('content')
      <div class=" pl-2 pr-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
          <div
              ...
              <button type="button" data-modal-target="tambah-Slider" data-modal-toggle="tambah-Slider"
                  ...
                  <tbody class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                      @foreach ($slider as $item)
                          <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                              ...
                              <td class="px-4 py-2">
                                  <img src="{{ asset('storage/' . $item->foto) }}" alt="Slider Image"
                                      class="w-48 h-28 object-cover rounded shadow">
                              </td>
                              ...
                              <td class="px-4 py-2 space-x-2">
                                  ...
                                  <button onclick="deleteForm('{{ route('admin.slider.destroy', $item->id) }}')"
      ...
      @include('components.admin.modalTambah-Slider')
