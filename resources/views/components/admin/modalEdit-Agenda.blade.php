<div id="edit-Agenda-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-Agenda-{{ $item->id }}">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <form method="POST" action="{{ route('admin.agenda.update', $item->id) }}"
                    ...
                    <div class="mb-4">
                        <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Acara</label>
                        <input type="text" name="acara" value="{{ $item->acara }}"
