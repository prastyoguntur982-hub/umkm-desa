  <div id="edit-Alur-{{ $item->id }}" tabindex="-1" aria-hidden="true"
          ...
          <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
              ...
              <div
                  ...
                  <button type="button"
                      ...
                      data-modal-hide="edit-Alur-{{ $item->id }}">
              ...
              <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                  <form method="POST" action="{{ route('admin.alur.update', $item->id) }}"
                      ...
                      <div class="mb-4">
                          ...
                          <select name="kategori"
                              ...
                              <option value="Alur Penyelesaian Sengketa"
                                  {{ $item->kategori == 'Alur Penyelesaian Sengketa' ? 'selected' : '' }}>
                                  Alur Penyelesaian Sengketa
                              </option>
                              <option value="Alur Pengajuan keberatan"
                                  {{ $item->kategori == 'Alur Pengajuan keberatan' ? 'selected' : '' }}>
                      ...
                      <div class="mb-4">
                          ...
                          <textarea name="keterangan" rows="3"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $item->keterangan }}</textarea>
                      </div>

                      <!-- UU Terkait -->
                      <div class="mb-4">
                          <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">UU Terkait</label>
                          <textarea name="uu_terkait" rows="3"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $item->uu_terkait }}</textarea>
                          <small>
                              <strong>Catatan:</strong><br>
                              Gunakan format berikut untuk membuat list bertingkat<br>pada kolom
                              <strong>Keterangan</strong> dan <strong>UU Terkait</strong> :<br>
