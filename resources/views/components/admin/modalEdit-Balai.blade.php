<div id="edit-Balai-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-Balai-{{ $item->id }}">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <form method="POST" action="{{ route('admin.balai.update', $item->id) }}"
                    ...
                    <div class="mb-2">
                        ...
                        <select name="kategori"
                            ...
                            <option value="Balai Pengembangan Kemasan dan Industri Kreatif"
                                {{ $item->kategori == 'Balai Pengembangan Kemasan dan Industri Kreatif' ? 'selected' : '' }}>
                                Balai Pengembangan Kemasan dan Industri Kreatif
                            </option>
                            <option value="Balai Pengujian dan Sertifikasi Mutu Barang"
                                {{ $item->kategori == 'Balai Pengujian dan Sertifikasi Mutu Barang' ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="deskripsi" rows="4"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $item->deskripsi }}</textarea>
                    </div>
