<!-- Modal Edit -->
<div id="edit-detailPasar-{{ $detailPasar->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-detailPasar-{{ $detailPasar->id }}">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                ...
                <!-- Form Mengedit Detail Pasar -->
                <form method="POST" action="{{ route('admin.pasars.updateDetail', $detailPasar->id) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="kategori" value="{{ $detailPasar->kategori }}"
                    ...
                    <div>
                        ...
                        <input type="text" id="keterangan" name="keterangan"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            value="{{ $detailPasar->keterangan }}" required>
                    ...
                    <div>
                        ...
                        <textarea name="deskripsi" rows="4"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                            required>{{ $detailPasar->deskripsi }}</textarea>
                        <small>
                            <strong>Catatan:</strong><br>
                            Gunakan format berikut untuk membuat list bertingkat<br>pada kolom <strong>Deskripsi</strong> :<br>
                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                            class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Simpan</button>
                    </div>
                </form>
            </div>
        </div>
