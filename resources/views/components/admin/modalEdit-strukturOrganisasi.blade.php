<!-- Modal Edit -->
<div id="edit-strukturOrganisasi-{{ $item->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-strukturOrganisasi-{{ $item->id }}">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <form  method="POST"
                    action="{{ route('admin.struktur-organisasi.update', $item->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <select id="parent_id" name="parent_id"
                            ...
                            <option value="" disabled {{ !$item->parent_id ? 'selected' : '' }}>Pilih Posisi
                                Bagan
                            </option>
                            @foreach ($struktur as $parent)
                                <option value="{{ $parent->id }}"
                                    {{ $item->parent_id == $parent->id ? 'selected' : '' }}>
