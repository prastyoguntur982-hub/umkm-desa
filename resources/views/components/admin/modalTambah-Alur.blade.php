  <div id="tambah-Alur" tabindex="-1" aria-hidden="true"
                  ...
                  <form action="{{ route('admin.alur.store') }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="mb-4">
                          ...
                          <select name="kategori"
                              ...
                              <option value="Alur Penyelesaian Sengketa">Alur Penyelesaian Sengketa</option>
                              <option value="Alur Pengajuan keberatan">Alur Pengajuan keberatan
                              </option>
                          </select>
                      </div>
                      <div class="mb-4">
                          ...
                          <textarea type="text" name="keterangan"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
                      </div>
                      <div class="mb-4">
                          <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">UU Terkait</label>
                          <textarea type="text" name="uu_terkait"
                              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white"></textarea>
                      ...
                      <div class="mb-4">
                          ...
                          <input
                              ...
                              type="file" name="gambar" class="w-full mt-1">
                      </div>
