<div id="tambah-Formulir" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-Formulir">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <form action="{{ route('admin.formulir.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label class="mb-4 block text-sm font-medium text-gray-900 dark:text-white">Kategori</label>
                        <select name="kategori"
                            ...
                            <option value="Formulir Pengajuan Keberatan">Formulir Pengajuan Keberatan</option>
                            <option value="Formulir Permintaan Informasi Publik">Formulir Permintaan Informasi Publik
                            </option>
                            <option value="Formulir Pengaduan">Formulir Pengaduan</option>
                        </select>

                    </div>
                    <div class="mb-4">
                        <label class="mb-4 block text-sm font-medium text-gray-900 dark:text-white">URL</label>
