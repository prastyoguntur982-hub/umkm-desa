 <div id="tambah-Pasar" tabindex="-1" aria-hidden="true"
     ...
     <div class="relative p-4 w-full max-w-md max-h-full">
         ...
         <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
             ...
             <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                 <form action="{{ route('admin.pasars.store') }}" method="POST" enctype="multipart/form-data">
                     @csrf
                     <div class="mb-4">
