<div id="tambah-Ppid" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <form id="formTambahDokumenPpid" action="{{ route('admin.ppid.store') }}" method="POST"
                    ...
                    <div class="mb-4">
                        ...
                        <select name="kategori"
                            ...
                            <option value="Informasi wajib berkala diumumkan">Informasi wajib berkala diumumkan
                            </option>
                            <option value="Informasi tersedia setiap saat">Informasi tersedia setiap saat
                            </option>
                            <option value="Media informasi lainnya">Media informasi lainnya</option>
