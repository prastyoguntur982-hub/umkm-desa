  <!-- Modal Tambah -->
 <div id="tambahModal-Galeri" tabindex="-1" aria-hidden="true"
     ...
     <div class="relative p-4 w-full max-w-md max-h-full">
         ...
         <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
             ...
             <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                 <form id="formTambahKategoriGaleri" action="{{ route('admin.galeri.storeKategoriGaleri') }}"
                     ...
                     <div class="mb-4">
                         <label class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Thumbnail</label>
                         <input
                 ...
                 <!-- Form tambah galeri -->
                 <form class="space-y-4" id="formTambahGaleri" action="{{ route('admin.galeri.store') }}" method="POST"
                     enctype="multipart/form-data">

                     @csrf
                     <div>
                         <label for="pasar_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kategori</label>
                         <div class="relative">
