<div id="tambah-komoditasPasar" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                   ...
                   data-modal-hide="tambah-komoditasPasar">
            ...
            <div class="max-w-lg mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
                <form action="{{ route('admin.info-harga.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
